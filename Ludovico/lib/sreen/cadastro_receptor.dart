...
class CadastroReceptor extends StatefulWidget {
  const CadastroReceptor({super.key});

  @override
  State<CadastroReceptor> createState() => _CadastroReceptorState();
}

class _CadastroReceptorState extends State<CadastroReceptor> {
